...
const Home = () => (
  <section className="home">
    <div className="home-hero">
      <img src={profile} alt="Kyaw Zin Thant" className="home-profile" />
      <h1>Kyaw Zin Thant</h1>
      <h2>Senior Full Stack Developer</h2>
      <p>🇲🇲 From Myanmar • Working in 🇻🇳 Vietnam • 6+ years of experience</p>
      <p className="home-tags">
        React • Node.js • AWS • Spring Boot • Docker • Terraform
      </p>
      <div className="home-links">
        <a href="mailto:kyawzinucsm89@gmail.com">📧 Email</a>
        <a href="https://github.com/kyawzinucsm89" target="_blank" rel="noreferrer">💻 GitHub</a>
        <a href="https://linkedin.com/in/kyaw-zin-thant-16897615a/" target="_blank" rel="noreferrer">🔗 LinkedIn</a>
        <a href="/assets/KyawZinThant_Resume.pdf" download>📄 Resume</a>
      </div>
    </div>
  </section>
);
